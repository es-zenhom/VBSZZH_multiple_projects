        ...
        // int y=9999;
         ...
         if (ak4_pt_eta_cut_overlap_4d.size()>=2)
         {
             ...
             if (ak8_pt_msoftdrop_cut_4d.size()>=3)
             {
                 ...
                 hist_m_H_msoftdrop->Fill(vec_soft[position_max_H_score]);
                 if (ak8_pt_msoftdrop_cut_4d.size()==3)
                 {
                       nooffat3++;
                      for (int i8 = 0; i8 < 3; i8++)
                      {
                           if (i8!=position_max_H_score)
                           {
                                ...
                                vec_msoftdrop_two_bosons.push_back(FatJet_msoftdrop[i8]);
                           }
                      }
