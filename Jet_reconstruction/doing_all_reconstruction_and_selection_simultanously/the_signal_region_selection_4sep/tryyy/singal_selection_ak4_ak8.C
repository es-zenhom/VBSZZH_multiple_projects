...
{
    // read file and TTree
    TDavixFile* readf = new TDavixFile ("http://uaf-10.t2.ucsd.edu/~phchang/dump/forEslam/mc/RunIISummer19UL18NanoAOD/TTToHadronic_TuneCP5_13TeV-powheg-pythia8/NANOAODSIM/106X_upgrade2018_realistic_v11_L1v1-v2/100000/839C7428-AE30-D845-91BF-721E1A28BB52.root","open");
    TTree* Events = (TTree*) readf->Get("Events");
    TDavixFile * f_output =new TDavixFile ("output.root","recreate");
        ...
        // int y=9999;
         ...
         if (ak4_pt_eta_cut_overlap_4d.size()>=2)
         {
             ...
             if (ak8_pt_msoftdrop_cut_4d.size()>=3)
             {
                 ...
                 {
                      hist_pt_leadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_first_quark_with_high_mqq].pt());
                      hist_pt_subleadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_second_quark_with_high_mqq].pt());
                      hist_eta_leadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_first_quark_with_high_mqq].eta());
                      hist_eta_subleadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_second_quark_with_high_mqq].eta());
                      hist_phi_leadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_first_quark_with_high_mqq].phi());
                      hist_phi_subleadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_second_quark_with_high_mqq].phi());

                 }
                 else
                 {
                      hist_pt_leadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_second_quark_with_high_mqq].pt());
                      hist_pt_subleadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_first_quark_with_high_mqq].pt());
                      hist_eta_leadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_second_quark_with_high_mqq].eta());
                      hist_eta_subleadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_first_quark_with_high_mqq].eta());
                      hist_phi_leadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_second_quark_with_high_mqq].phi());
                      hist_phi_subleadVBFQuark->Fill(ak4_pt_eta_cut_overlap_4d[position_first_quark_with_high_mqq].phi());

                 }
                 // create mjj (invariant mass of the two vbf jets)
                 hist_mjj_mass_of_twoVBFjets->Fill((ak4_pt_eta_cut_overlap_4d[position_first_quark_with_high_mqq]+ak4_pt_eta_cut_overlap_4d[position_second_quark_with_high_mqq]).mass());
                 // get the abs eta of the two vbf quarks
                 hist_absDelta_eta_of_twoVBFjets->Fill(TMath::Abs(ak4_pt_eta_cut_overlap_4d[position_first_quark_with_high_mqq].eta()-ak4_pt_eta_cut_overlap_4d[position_second_quark_with_high_mqq].eta()));
                 ...
                 hist_pt_H_fatjet->Fill(ak8_pt_msoftdrop_cut_4d[position_max_H_score].pt());
                 hist_eta_H_fatjet->Fill(ak8_pt_msoftdrop_cut_4d[position_max_H_score].eta());
                 hist_phi_H_fatjet->Fill(ak8_pt_msoftdrop_cut_4d[position_max_H_score].phi());
                 hist_m_H_msoftdrop->Fill(vec_msoftdrop[position_max_H_score]);
                 // if (ak8_pt_msoftdrop_cut_4d.size()==3)
                 // {
                  nooffat3++;
                  ...
                  {
                      hist_pt_leadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[0].pt());
                      hist_pt_subleadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[1].pt());
                      hist_eta_leadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[0].eta());
                      hist_eta_subleadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[1].eta());
                      hist_phi_leadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[0].phi());
                      hist_phi_subleadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[1].phi());
                      hist_m_leadboson_msoftdrop->Fill(vec_msoftdrop_two_bosons[0]);
                      hist_m_subleadboson_msoftdrop->Fill(vec_msoftdrop_two_bosons[1]);

                  }
                  else
                  {
                      hist_pt_leadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[1].pt());
                      hist_pt_subleadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[0].pt());
                      hist_eta_leadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[1].eta());
                      hist_eta_subleadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[0].eta());
                      hist_phi_leadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[1].phi());
                      hist_phi_subleadboson_fatjet->Fill(vec_lead_sublead_bosons_4d[0].phi());
                      hist_m_leadboson_msoftdrop->Fill(vec_msoftdrop_two_bosons[1]);
                      hist_m_subleadboson_msoftdrop->Fill(vec_msoftdrop_two_bosons[0]);
                  }

                  // invariant mass of H_Boson_Boson system
                hist_mass_HBosonBoson_system->Fill((ak8_pt_msoftdrop_cut_4d[position_max_H_score]+vec_lead_sublead_bosons_4d[0]+vec_lead_sublead_bosons_4d[1]).mass());
         ...
         c1->cd();
         c1->SaveAs("pT of leading VBFquark.root");
