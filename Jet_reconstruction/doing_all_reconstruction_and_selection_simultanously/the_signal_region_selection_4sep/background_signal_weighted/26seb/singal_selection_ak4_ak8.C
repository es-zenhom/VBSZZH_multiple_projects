...
void singal_selection_ak4_ak8()
{
    // read file and TTree
    TChain* chain = new TChain("Events");
    TChain* chain1 = new TChain("Runs");
    chain->Add("/home/users/eslam.zenhom/public_html/uf_work/VBSZZH/E6EE03D7-5EC1-9D4D-9E41-605619ADD3C2.root");
    chain1->Add("/home/users/eslam.zenhom/public_html/uf_work/VBSZZH/E6EE03D7-5EC1-9D4D-9E41-605619ADD3C2.root");
    TFile * f_output =new TFile ("background.root","recreate");
...
// nevents++;
         ...
         float weight_of_eachevent= (genWeight[0]/sumweights)*687.1*1000*137;
