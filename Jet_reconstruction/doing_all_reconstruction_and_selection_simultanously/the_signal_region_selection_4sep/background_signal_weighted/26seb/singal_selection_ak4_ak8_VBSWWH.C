...
void singal_selection_ak4_ak8_VBSWWH()
{
    // read file and TTree
    TChain* chain = new TChain("Events");
    TChain* chain1 = new TChain("Runs");
    chain->Add("/ceph/cms/store/user/phchang/VBSVVHSignalSamples_v2/RunIISummer20UL18_VBSWWH_incl_v2_C2V_0_Azure/merged/*.root");
    chain1->Add("/ceph/cms/store/user/phchang/VBSVVHSignalSamples_v2/RunIISummer20UL18_VBSWWH_incl_v2_C2V_0_Azure/merged/*.root");
    TFile * f_output =new TFile ("sig_VBSWWH.root","recreate");
...
// nevents++;
         ...
         float weight_of_eachevent= (genWeight[0]/sumweights)*0.001037*1000*137;
