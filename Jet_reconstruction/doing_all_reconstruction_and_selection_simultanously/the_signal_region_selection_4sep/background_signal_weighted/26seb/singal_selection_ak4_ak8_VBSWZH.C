...
void singal_selection_ak4_ak8_VBSWZH()
{
    // read file and TTree
    TChain* chain = new TChain("Events");
    TChain* chain1 = new TChain("Runs");
    chain->Add("/ceph/cms/store/user/phchang/VBSVVHSignalSamples_v2/RunIISummer20UL18_VBSWZH_incl_C2V_0_Azure_v1/merged/*.root");
    chain1->Add("/ceph/cms/store/user/phchang/VBSVVHSignalSamples_v2/RunIISummer20UL18_VBSWZH_incl_C2V_0_Azure_v1/merged/*.root");
    TFile * f_output =new TFile ("sig_VBSWZH.root","recreate");
...
// nevents++;
         ...
         float weight_of_eachevent= (genWeight[0]/sumweights)*0.001169*1000*137;
